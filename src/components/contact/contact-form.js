...
const ContactForm = () => {
  return (
   <>
    <h2 className="mb-3 text-5 text-uppercase text-center text-md-start">Send us a note</h2>
			<form id="contact-form" action="php/mail.php" method="post">
			  ...
			  <div className="row g-4">
				...
				<div className="col">
					<textarea name="form-message" className="form-control" rows="5" required="" placeholder="Tell us more about your needs........"></textarea>
				</div>
              </div>
